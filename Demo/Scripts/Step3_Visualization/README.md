...
- For each reference image selected in Step 2, the associated query images are projected onto the reference image using the estimated camera parameters and depthmaps.  
