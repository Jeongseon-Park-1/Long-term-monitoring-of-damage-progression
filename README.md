...
The workflow integrates YOLOv8-based damage segmentation, structure-from-motion (SfM), and hierarchical localization (hloc) to enable consistent damage identification and tracking across different inspection times.
